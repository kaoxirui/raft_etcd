...
TEST(wal, ScanWalName) {
    ...
    test.push_back(
        Test{.str = "0000000000000000-0000000000000000.wal", .wseq = 0, .windex = 0, .wok = true});
    test.push_back(Test{.str = "0000000000000100-0000000000000101.wal",
                        .wseq = 0x100,
                        .windex = 0x101,
                        .wok = true});
    test.push_back(Test{.str = "0000000000000000.wa", .wseq = 0, .windex = 0, .wok = false});
    test.push_back(Test{
        .str = "0000000000000000-0000000000000000.snap", .wseq = 0, .windex = 0, .wok = false});
    for (auto &test : test) {
        uint64_t seq;
        uint64_t index;
...
TEST(wal, SearchIndex) {
    ...
    {
        Test t;
        t.names = {"0000000000000000-0000000000000000.wal", "0000000000000001-0000000000001000.wal",
    ...
    {
        Test t;
        t.names = {"0000000000000001-0000000000004000.wal", "0000000000000002-0000000000003000.wal",
    ...
    {
        Test t;
        t.names = {"0000000000000001-0000000000002000.wal", "0000000000000002-0000000000003000.wal",
                   "0000000000000003-0000000000005000.wal"};
        t.index = 0x1000;
        t.widx = -1;
        t.wok = false;
