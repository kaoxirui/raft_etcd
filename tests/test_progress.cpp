...
TEST(progress, MaybeDecr) {
    ...
    tests.push_back(Test{.state = ProgressStateReplicate,
                         .m = 5,
                         .n = 10,
                         .rejected = 5,
                         .last = 5,
    ...
    tests.push_back(Test{.state = ProgressStateProbe,
                         .m = 0,
                         .n = 0,
                         .rejected = 0,
                         .last = 0,
    ...
    tests.push_back(Test{
        .state = ProgressStateProbe, .m = 0, .n = 2, .rejected = 1, .last = 1, .w = true, .wn = 1});
    tests.push_back(Test{
        .state = ProgressStateProbe, .m = 0, .n = 1, .rejected = 0, .last = 0, .w = true, .wn = 1});
    tests.push_back(Test{.state = ProgressStateProbe,
                         .m = 0,
                         .n = 10,
                         .rejected = 9,
